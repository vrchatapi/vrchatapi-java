...
public class UsersApi {
     ...
     */
    public List<LimitedGroup> getUserGroups(String userId) throws ApiException {
        ApiResponse<List<LimitedGroup>> localVarResp = getUserGroupsWithHttpInfo(userId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<LimitedGroup>> getUserGroupsWithHttpInfo(String userId) throws ApiException {
     ...
     */
    public okhttp3.Call getUserGroupsAsync(String userId, final ApiCallback<List<LimitedGroup>> _callback) throws ApiException {
