...
public class UsersApi {
    ...
    private okhttp3.Call searchActiveUsersValidateBeforeCall(String search, String developerType, Integer offset, Integer n, final ApiCallback _callback) throws ApiException {
        ...
        return searchActiveUsersCall(search, developerType, offset, n, _callback);
     ...
     */
    @Deprecated
    public List<LimitedUserFriend> searchActiveUsers(String search, String developerType, Integer offset, Integer n) throws ApiException {
        ApiResponse<List<LimitedUserFriend>> localVarResp = searchActiveUsersWithHttpInfo(search, developerType, offset, n);
        return localVarResp.getData();
    }
     ...
     * @param offset A zero-based offset from the default object sorting from where search results start. (optional)
     * @param n The number of objects to return. (optional, default to 60)
     * @return ApiResponse&lt;List&lt;LimitedUserFriend&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    @Deprecated
    public ApiResponse<List<LimitedUserFriend>> searchActiveUsersWithHttpInfo(String search, String developerType, Integer offset, Integer n) throws ApiException {
        okhttp3.Call localVarCall = searchActiveUsersValidateBeforeCall(search, developerType, offset, n, null);
        Type localVarReturnType = new TypeToken<List<LimitedUserFriend>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    @Deprecated
    public okhttp3.Call searchActiveUsersAsync(String search, String developerType, Integer offset, Integer n, final ApiCallback<List<LimitedUserFriend>> _callback) throws ApiException {
     ...
     */
    public List<LimitedUserSearch> searchUsers(String search, String developerType, Integer n, Integer offset) throws ApiException {
        ApiResponse<List<LimitedUserSearch>> localVarResp = searchUsersWithHttpInfo(search, developerType, n, offset);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<LimitedUserSearch>> searchUsersWithHttpInfo(String search, String developerType, Integer n, Integer offset) throws ApiException {
     ...
     */
    public okhttp3.Call searchUsersAsync(String search, String developerType, Integer n, Integer offset, final ApiCallback<List<LimitedUserSearch>> _callback) throws ApiException {
