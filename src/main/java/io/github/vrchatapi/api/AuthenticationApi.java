...
public class AuthenticationApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  * Set-Cookie - Authenticating returns an &#x60;auth&#x60; cookie. <br>  * \0Set-Cookie - Authenticating also sets the &#x60;apiKey&#x60; if not already set. <br>  </td></tr>
        <tr><td> 401 </td><td> Error response due to missing apiKey or auth cookie. </td><td>  -  </td></tr>
     </table>
     */
