...
import io.github.vrchatapi.model.RegisterUserAccount200Response;
...
public class AuthenticationApi {
     ...
     */
    public ApiResponse<Void> confirmEmailWithHttpInfo(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull String verifyEmail) throws ApiException {
     ...
     */
    public okhttp3.Call confirmEmailAsync(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull String verifyEmail, final ApiCallback<Void> _callback) throws ApiException {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns a single AvatarModerationCreated object </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Error response due to missing auth cookie. </td><td>  -  </td></tr>
     </table>
     */
    ...
    public AvatarModerationCreated createGlobalAvatarModeration(@javax.annotation.Nonnull CreateAvatarModerationRequest createAvatarModerationRequest) throws ApiException {
        ApiResponse<AvatarModerationCreated> localVarResp = createGlobalAvatarModerationWithHttpInfo(createAvatarModerationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AvatarModerationCreated> createGlobalAvatarModerationWithHttpInfo(@javax.annotation.Nonnull CreateAvatarModerationRequest createAvatarModerationRequest) throws ApiException {
        okhttp3.Call localVarCall = createGlobalAvatarModerationValidateBeforeCall(createAvatarModerationRequest, null);
        Type localVarReturnType = new TypeToken<AvatarModerationCreated>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call createGlobalAvatarModerationAsync(@javax.annotation.Nonnull CreateAvatarModerationRequest createAvatarModerationRequest, final ApiCallback<AvatarModerationCreated> _callback) throws ApiException {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns a single OkStatus2 object </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Error response due to missing auth cookie. </td><td>  -  </td></tr>
     </table>
     */
    ...
    public OkStatus2 deleteGlobalAvatarModeration(@javax.annotation.Nonnull String targetAvatarId, @javax.annotation.Nonnull AvatarModerationType avatarModerationType) throws ApiException {
        ApiResponse<OkStatus2> localVarResp = deleteGlobalAvatarModerationWithHttpInfo(targetAvatarId, avatarModerationType);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OkStatus2> deleteGlobalAvatarModerationWithHttpInfo(@javax.annotation.Nonnull String targetAvatarId, @javax.annotation.Nonnull AvatarModerationType avatarModerationType) throws ApiException {
        okhttp3.Call localVarCall = deleteGlobalAvatarModerationValidateBeforeCall(targetAvatarId, avatarModerationType, null);
        Type localVarReturnType = new TypeToken<OkStatus2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete Global Avatar Moderation (asynchronously)
     * Globally unmoderates an avatar.
     * @param targetAvatarId Must be a valid avatar ID. (required)
     * @param avatarModerationType The avatar moderation type associated with the avatar. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call deleteGlobalAvatarModerationAsync(@javax.annotation.Nonnull String targetAvatarId, @javax.annotation.Nonnull AvatarModerationType avatarModerationType, final ApiCallback<OkStatus2> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteGlobalAvatarModerationValidateBeforeCall(targetAvatarId, avatarModerationType, _callback);
        Type localVarReturnType = new TypeToken<OkStatus2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteModerationReport
     * @param moderationReportId The moderation report id. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteModerationReportValidateBeforeCall(@javax.annotation.Nonnull String moderationReportId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'moderationReportId' is set
        if (moderationReportId == null) {
            throw new ApiException("Missing the required parameter 'moderationReportId' when calling deleteModerationReport(Async)");
        }

        return deleteModerationReportCall(moderationReportId, _callback);
     ...
     */
    public SuccessFlag deleteModerationReport(@javax.annotation.Nonnull String moderationReportId) throws ApiException {
        ApiResponse<SuccessFlag> localVarResp = deleteModerationReportWithHttpInfo(moderationReportId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SuccessFlag> deleteModerationReportWithHttpInfo(@javax.annotation.Nonnull String moderationReportId) throws ApiException {
        okhttp3.Call localVarCall = deleteModerationReportValidateBeforeCall(moderationReportId, null);
        Type localVarReturnType = new TypeToken<SuccessFlag>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete Moderation Report (asynchronously)
     * Delete a moderation report
     * @param moderationReportId The moderation report id. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteModerationReportAsync(@javax.annotation.Nonnull String moderationReportId, final ApiCallback<SuccessFlag> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteModerationReportValidateBeforeCall(moderationReportId, _callback);
        Type localVarReturnType = new TypeToken<SuccessFlag>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public CurrentUser deleteUser(@javax.annotation.Nonnull String userId) throws ApiException {
     ...
     */
    public ApiResponse<CurrentUser> deleteUserWithHttpInfo(@javax.annotation.Nonnull String userId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteUserAsync(@javax.annotation.Nonnull String userId, final ApiCallback<CurrentUser> _callback) throws ApiException {
    ...
    public okhttp3.Call getCurrentUserCall(final ApiCallback _callback) throws ApiException {
        ...
        String[] localVarAuthNames = new String[] { "authHeader", "twoFactorAuthCookie", "authCookie" };
        return localVarApiClient.buildCall(basePath, localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAuthNames, _callback);
    }
     ...
     */
    public RegisterUserAccount200Response getCurrentUser() throws ApiException {
        ApiResponse<RegisterUserAccount200Response> localVarResp = getCurrentUserWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * Login and/or Get Current User Info
     * This endpoint does the following two operations:   1) Checks if you are already logged in by looking for a valid &#x60;auth&#x60; cookie. If you are have a valid auth cookie then no additional auth-related actions are taken. If you are **not** logged in then it will log you in with the &#x60;Authorization&#x60; header and set the &#x60;auth&#x60; cookie. The &#x60;auth&#x60; cookie will only be sent once.   2) If logged in, this function will also return the CurrentUser object containing detailed information about the currently logged in user.  The auth string after &#x60;Authorization: Basic {string}&#x60; is a base64-encoded string of the username and password, both individually url-encoded, and then joined with a colon.  &gt; base64(urlencode(username):urlencode(password))  **WARNING: Session Limit:** Each authentication with login credentials counts as a separate session, out of which you have a limited amount. Make sure to save and reuse the &#x60;auth&#x60; cookie if you are often restarting the program. The provided API libraries automatically save cookies during runtime, but does not persist during restart. While it can be fine to use username/password during development, expect in production to very fast run into the rate-limit and be temporarily blocked from making new sessions until older ones expire. The exact number of simultaneous sessions is unknown/undisclosed.
     * @return ApiResponse&lt;RegisterUserAccount200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<RegisterUserAccount200Response> getCurrentUserWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getCurrentUserValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<RegisterUserAccount200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getCurrentUserAsync(final ApiCallback<RegisterUserAccount200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for getGlobalAvatarModerations
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns list of globally blocked avatars with timestamps </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Error response due to missing auth cookie. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getGlobalAvatarModerationsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGlobalAvatarModerationsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getGlobalAvatarModerationsCall(_callback);
     ...
     */
    public List<AvatarModeration> getGlobalAvatarModerations() throws ApiException {
        ApiResponse<List<AvatarModeration>> localVarResp = getGlobalAvatarModerationsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * Get Global Avatar Moderations
     * Returns list of globally moderated avatars.
     * @return ApiResponse&lt;List&lt;AvatarModeration&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<AvatarModeration>> getGlobalAvatarModerationsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getGlobalAvatarModerationsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<AvatarModeration>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Global Avatar Moderations (asynchronously)
     * Returns list of globally moderated avatars.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getGlobalAvatarModerationsAsync(final ApiCallback<List<AvatarModeration>> _callback) throws ApiException {
     ...
     * @param reportingUserId Filter for moderation reports. (optional)
     * @param status Filter for moderation reports. One of: &#x60;closed&#x60;... (optional)
     * @param type Filter for moderation reports. One of: &#x60;avatar&#x60;, &#x60;group&#x60;, &#x60;user&#x60;, &#x60;world&#x60;... (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns a list of ModerationReport objects, wrapped in new pagination format. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Error response due to missing auth cookie. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Error response due to missing Administrator credentials. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getModerationReportsCall(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable String reportingUserId, @javax.annotation.Nullable String status, @javax.annotation.Nullable String type, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/moderationReports";
        ...
        if (reportingUserId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("reportingUserId", reportingUserId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getModerationReportsValidateBeforeCall(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable String reportingUserId, @javax.annotation.Nullable String status, @javax.annotation.Nullable String type, final ApiCallback _callback) throws ApiException {
        return getModerationReportsCall(offset, n, reportingUserId, status, type, _callback);
     ...
     */
    public PaginatedModerationReportList getModerationReports(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable String reportingUserId, @javax.annotation.Nullable String status, @javax.annotation.Nullable String type) throws ApiException {
        ApiResponse<PaginatedModerationReportList> localVarResp = getModerationReportsWithHttpInfo(offset, n, reportingUserId, status, type);
        return localVarResp.getData();
    }
     ...
     * @param status Filter for moderation reports. One of: &#x60;closed&#x60;... (optional)
     * @param type Filter for moderation reports. One of: &#x60;avatar&#x60;, &#x60;group&#x60;, &#x60;user&#x60;, &#x60;world&#x60;... (optional)
     * @return ApiResponse&lt;PaginatedModerationReportList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<PaginatedModerationReportList> getModerationReportsWithHttpInfo(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable String reportingUserId, @javax.annotation.Nullable String status, @javax.annotation.Nullable String type) throws ApiException {
        okhttp3.Call localVarCall = getModerationReportsValidateBeforeCall(offset, n, reportingUserId, status, type, null);
        Type localVarReturnType = new TypeToken<PaginatedModerationReportList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Moderation Reports (asynchronously)
     * Get submitted moderation reports
     * @param offset A zero-based offset from the default object sorting from where search results start. (optional)
     * @param n The number of objects to return. (optional, default to 60)
     * @param reportingUserId Filter for moderation reports. (optional)
     ...
     */
    public okhttp3.Call getModerationReportsAsync(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable String reportingUserId, @javax.annotation.Nullable String status, @javax.annotation.Nullable String type, final ApiCallback<PaginatedModerationReportList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getModerationReportsValidateBeforeCall(offset, n, reportingUserId, status, type, _callback);
        Type localVarReturnType = new TypeToken<PaginatedModerationReportList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    @Deprecated
    public okhttp3.Call registerUserAccountCall(@javax.annotation.Nonnull RegisterUserAccountRequest registerUserAccountRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call registerUserAccountValidateBeforeCall(@javax.annotation.Nonnull RegisterUserAccountRequest registerUserAccountRequest, final ApiCallback _callback) throws ApiException {
     ...
     */
    @Deprecated
    public RegisterUserAccount200Response registerUserAccount(@javax.annotation.Nonnull RegisterUserAccountRequest registerUserAccountRequest) throws ApiException {
        ApiResponse<RegisterUserAccount200Response> localVarResp = registerUserAccountWithHttpInfo(registerUserAccountRequest);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<RegisterUserAccount200Response> registerUserAccountWithHttpInfo(@javax.annotation.Nonnull RegisterUserAccountRequest registerUserAccountRequest) throws ApiException {
     ...
     */
    @Deprecated
    public okhttp3.Call registerUserAccountAsync(@javax.annotation.Nonnull RegisterUserAccountRequest registerUserAccountRequest, final ApiCallback<RegisterUserAccount200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for submitModerationReport
     * @param submitModerationReportRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns a single ModerationReport object. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Error response due to missing auth cookie. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call submitModerationReportCall(@javax.annotation.Nonnull SubmitModerationReportRequest submitModerationReportRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = submitModerationReportRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call submitModerationReportValidateBeforeCall(@javax.annotation.Nonnull SubmitModerationReportRequest submitModerationReportRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'submitModerationReportRequest' is set
        if (submitModerationReportRequest == null) {
            throw new ApiException("Missing the required parameter 'submitModerationReportRequest' when calling submitModerationReport(Async)");
        }

        return submitModerationReportCall(submitModerationReportRequest, _callback);
     ...
     */
    public ModerationReport submitModerationReport(@javax.annotation.Nonnull SubmitModerationReportRequest submitModerationReportRequest) throws ApiException {
        ApiResponse<ModerationReport> localVarResp = submitModerationReportWithHttpInfo(submitModerationReportRequest);
        return localVarResp.getData();
    }
     ...
     * Submit a moderation report
     * @param submitModerationReportRequest  (required)
     * @return ApiResponse&lt;ModerationReport&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<ModerationReport> submitModerationReportWithHttpInfo(@javax.annotation.Nonnull SubmitModerationReportRequest submitModerationReportRequest) throws ApiException {
        okhttp3.Call localVarCall = submitModerationReportValidateBeforeCall(submitModerationReportRequest, null);
        Type localVarReturnType = new TypeToken<ModerationReport>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Submit Moderation Report (asynchronously)
     * Submit a moderation report
     * @param submitModerationReportRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call submitModerationReportAsync(@javax.annotation.Nonnull SubmitModerationReportRequest submitModerationReportRequest, final ApiCallback<ModerationReport> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call verify2FACall(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verify2FAValidateBeforeCall(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Verify2FAResult verify2FA(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode) throws ApiException {
     ...
     */
    public ApiResponse<Verify2FAResult> verify2FAWithHttpInfo(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode) throws ApiException {
     ...
     */
    public okhttp3.Call verify2FAAsync(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode, final ApiCallback<Verify2FAResult> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call verify2FAEmailCodeCall(@javax.annotation.Nonnull TwoFactorEmailCode twoFactorEmailCode, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verify2FAEmailCodeValidateBeforeCall(@javax.annotation.Nonnull TwoFactorEmailCode twoFactorEmailCode, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Verify2FAEmailCodeResult verify2FAEmailCode(@javax.annotation.Nonnull TwoFactorEmailCode twoFactorEmailCode) throws ApiException {
     ...
     */
    public ApiResponse<Verify2FAEmailCodeResult> verify2FAEmailCodeWithHttpInfo(@javax.annotation.Nonnull TwoFactorEmailCode twoFactorEmailCode) throws ApiException {
     ...
     */
    public okhttp3.Call verify2FAEmailCodeAsync(@javax.annotation.Nonnull TwoFactorEmailCode twoFactorEmailCode, final ApiCallback<Verify2FAEmailCodeResult> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call verifyLoginPlaceCall(@javax.annotation.Nonnull String token, @javax.annotation.Nullable String userId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verifyLoginPlaceValidateBeforeCall(@javax.annotation.Nonnull String token, @javax.annotation.Nullable String userId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void verifyLoginPlace(@javax.annotation.Nonnull String token, @javax.annotation.Nullable String userId) throws ApiException {
     ...
     */
    public ApiResponse<Void> verifyLoginPlaceWithHttpInfo(@javax.annotation.Nonnull String token, @javax.annotation.Nullable String userId) throws ApiException {
     ...
     */
    public okhttp3.Call verifyLoginPlaceAsync(@javax.annotation.Nonnull String token, @javax.annotation.Nullable String userId, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call verifyPending2FACall(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verifyPending2FAValidateBeforeCall(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'twoFactorAuthCode' is set
        if (twoFactorAuthCode == null) {
     ...
     */
    public Verify2FAResult verifyPending2FA(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode) throws ApiException {
     ...
     */
    public ApiResponse<Verify2FAResult> verifyPending2FAWithHttpInfo(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode) throws ApiException {
     ...
     */
    public okhttp3.Call verifyPending2FAAsync(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode, final ApiCallback<Verify2FAResult> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call verifyRecoveryCodeCall(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verifyRecoveryCodeValidateBeforeCall(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'twoFactorAuthCode' is set
        if (twoFactorAuthCode == null) {
     ...
     */
    public Verify2FAResult verifyRecoveryCode(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode) throws ApiException {
     ...
     */
    public ApiResponse<Verify2FAResult> verifyRecoveryCodeWithHttpInfo(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode) throws ApiException {
     ...
     */
    public okhttp3.Call verifyRecoveryCodeAsync(@javax.annotation.Nonnull TwoFactorAuthCode twoFactorAuthCode, final ApiCallback<Verify2FAResult> _callback) throws ApiException {
