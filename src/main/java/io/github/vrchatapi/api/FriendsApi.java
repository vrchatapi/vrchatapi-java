...
import io.github.vrchatapi.model.BoopRequest;
...
public class FriendsApi {
    ...
    public okhttp3.Call boopCall(@javax.annotation.Nonnull String userId, @javax.annotation.Nonnull BoopRequest boopRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = boopRequest;

        // create path and map variables
        String localVarPath = "/users/{userId}/boop"
    ...
    private okhttp3.Call boopValidateBeforeCall(@javax.annotation.Nonnull String userId, @javax.annotation.Nonnull BoopRequest boopRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling boop(Async)");
        }

        // verify the required parameter 'boopRequest' is set
        if (boopRequest == null) {
            throw new ApiException("Missing the required parameter 'boopRequest' when calling boop(Async)");
        }

        return boopCall(userId, boopRequest, _callback);
    ...
    public Success boop(@javax.annotation.Nonnull String userId, @javax.annotation.Nonnull BoopRequest boopRequest) throws ApiException {
        ApiResponse<Success> localVarResp = boopWithHttpInfo(userId, boopRequest);
    ...
    public ApiResponse<Success> boopWithHttpInfo(@javax.annotation.Nonnull String userId, @javax.annotation.Nonnull BoopRequest boopRequest) throws ApiException {
        okhttp3.Call localVarCall = boopValidateBeforeCall(userId, boopRequest, null);
        Type localVarReturnType = new TypeToken<Success>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Send Boop (asynchronously)
     * Send a boop to another user.
     * @param userId Must be a valid user ID. (required)
     * @param boopRequest  (required)
    ...
    public okhttp3.Call boopAsync(@javax.annotation.Nonnull String userId, @javax.annotation.Nonnull BoopRequest boopRequest, final ApiCallback<Success> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = boopValidateBeforeCall(userId, boopRequest, _callback);
        Type localVarReturnType = new TypeToken<Success>(){}.getType();
     ...
     */
    public okhttp3.Call deleteFriendRequestCall(@javax.annotation.Nonnull String userId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteFriendRequestValidateBeforeCall(@javax.annotation.Nonnull String userId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
     ...
     */
    public Success deleteFriendRequest(@javax.annotation.Nonnull String userId) throws ApiException {
     ...
     */
    public ApiResponse<Success> deleteFriendRequestWithHttpInfo(@javax.annotation.Nonnull String userId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteFriendRequestAsync(@javax.annotation.Nonnull String userId, final ApiCallback<Success> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call friendValidateBeforeCall(@javax.annotation.Nonnull String userId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
     ...
     */
    public okhttp3.Call getFriendStatusCall(@javax.annotation.Nonnull String userId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFriendStatusValidateBeforeCall(@javax.annotation.Nonnull String userId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
     ...
     */
    public FriendStatus getFriendStatus(@javax.annotation.Nonnull String userId) throws ApiException {
     ...
     */
    public ApiResponse<FriendStatus> getFriendStatusWithHttpInfo(@javax.annotation.Nonnull String userId) throws ApiException {
     ...
     */
    public okhttp3.Call getFriendStatusAsync(@javax.annotation.Nonnull String userId, final ApiCallback<FriendStatus> _callback) throws ApiException {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns a list of LimitedUserFriend objects. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Error response due to missing auth cookie. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getFriendsCall(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable Boolean offline, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFriendsValidateBeforeCall(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable Boolean offline, final ApiCallback _callback) throws ApiException {
     ...
     */
    public List<LimitedUserFriend> getFriends(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable Boolean offline) throws ApiException {
        ApiResponse<List<LimitedUserFriend>> localVarResp = getFriendsWithHttpInfo(offset, n, offline);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<LimitedUserFriend>> getFriendsWithHttpInfo(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable Boolean offline) throws ApiException {
     ...
     */
    public okhttp3.Call getFriendsAsync(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer n, @javax.annotation.Nullable Boolean offline, final ApiCallback<List<LimitedUserFriend>> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call unfriendCall(@javax.annotation.Nonnull String userId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call unfriendValidateBeforeCall(@javax.annotation.Nonnull String userId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
     ...
     */
    public Success unfriend(@javax.annotation.Nonnull String userId) throws ApiException {
     ...
     */
    public ApiResponse<Success> unfriendWithHttpInfo(@javax.annotation.Nonnull String userId) throws ApiException {
     ...
     */
    public okhttp3.Call unfriendAsync(@javax.annotation.Nonnull String userId, final ApiCallback<Success> _callback) throws ApiException {
