...
public class GroupsApi {
     ...
     */
    public okhttp3.Call getGroupRequestsCall(String groupId, Integer n, Integer offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGroupRequestsValidateBeforeCall(String groupId, Integer n, Integer offset, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling getGroupRequests(Async)");
        }

        return getGroupRequestsCall(groupId, n, offset, _callback);
     ...
     */
    public List<GroupMember> getGroupRequests(String groupId, Integer n, Integer offset) throws ApiException {
        ApiResponse<List<GroupMember>> localVarResp = getGroupRequestsWithHttpInfo(groupId, n, offset);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<GroupMember>> getGroupRequestsWithHttpInfo(String groupId, Integer n, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getGroupRequestsValidateBeforeCall(groupId, n, offset, null);
        Type localVarReturnType = new TypeToken<List<GroupMember>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getGroupRequestsAsync(String groupId, Integer n, Integer offset, final ApiCallback<List<GroupMember>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGroupRequestsValidateBeforeCall(groupId, n, offset, _callback);
        Type localVarReturnType = new TypeToken<List<GroupMember>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
