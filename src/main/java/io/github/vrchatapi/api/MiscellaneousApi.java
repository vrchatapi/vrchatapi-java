...
import io.github.vrchatapi.model.CreatePermissionRequest;
import io.github.vrchatapi.model.Error;
import io.github.vrchatapi.model.InfoPush;
import java.time.OffsetDateTime;
import io.github.vrchatapi.model.Permission;
import io.github.vrchatapi.model.UpdatePermissionRequest;
...
public class MiscellaneousApi {
     ...
     * @param ownerId Owner of the Permission, MUST be valid UserID. (optional)
     ...
     */
    public okhttp3.Call createPermissionCall(Integer n, Integer offset, String ownerId, CreatePermissionRequest createPermissionRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createPermissionValidateBeforeCall(Integer n, Integer offset, String ownerId, CreatePermissionRequest createPermissionRequest, final ApiCallback _callback) throws ApiException {
        return createPermissionCall(n, offset, ownerId, createPermissionRequest, _callback);
     ...
     */
    public Permission createPermission(Integer n, Integer offset, String ownerId, CreatePermissionRequest createPermissionRequest) throws ApiException {
        ApiResponse<Permission> localVarResp = createPermissionWithHttpInfo(n, offset, ownerId, createPermissionRequest);
     ...
     */
    public ApiResponse<Permission> createPermissionWithHttpInfo(Integer n, Integer offset, String ownerId, CreatePermissionRequest createPermissionRequest) throws ApiException {
        okhttp3.Call localVarCall = createPermissionValidateBeforeCall(n, offset, ownerId, createPermissionRequest, null);
     ...
     */
    public okhttp3.Call createPermissionAsync(Integer n, Integer offset, String ownerId, CreatePermissionRequest createPermissionRequest, final ApiCallback<Permission> _callback) throws ApiException {

        okhttp3.Call localVarCall = createPermissionValidateBeforeCall(n, offset, ownerId, createPermissionRequest, _callback);
        Type localVarReturnType = new TypeToken<Permission>(){}.getType();
     ...
     */
    public Permission deletePermission(String permissionId) throws ApiException {
        ApiResponse<Permission> localVarResp = deletePermissionWithHttpInfo(permissionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Permission> deletePermissionWithHttpInfo(String permissionId) throws ApiException {
     ...
     */
    public okhttp3.Call deletePermissionAsync(String permissionId, final ApiCallback<Permission> _callback) throws ApiException {
     ...
     */
    public List<Permission> getPermissions() throws ApiException {
        ApiResponse<List<Permission>> localVarResp = getPermissionsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Permission>> getPermissionsWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call getPermissionsAsync(final ApiCallback<List<Permission>> _callback) throws ApiException {
     ...
     * @param permissionId Must be a valid permission ID. (required)
     * @param updatePermissionRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updatePermissionCall(String permissionId, UpdatePermissionRequest updatePermissionRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePermissionValidateBeforeCall(String permissionId, UpdatePermissionRequest updatePermissionRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'permissionId' is set
        if (permissionId == null) {
            throw new ApiException("Missing the required parameter 'permissionId' when calling updatePermission(Async)");
        }

        return updatePermissionCall(permissionId, updatePermissionRequest, _callback);
     ...
     */
    public Permission updatePermission(String permissionId, UpdatePermissionRequest updatePermissionRequest) throws ApiException {
        ApiResponse<Permission> localVarResp = updatePermissionWithHttpInfo(permissionId, updatePermissionRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Permission> updatePermissionWithHttpInfo(String permissionId, UpdatePermissionRequest updatePermissionRequest) throws ApiException {
        okhttp3.Call localVarCall = updatePermissionValidateBeforeCall(permissionId, updatePermissionRequest, null);
        Type localVarReturnType = new TypeToken<Permission>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updatePermissionAsync(String permissionId, UpdatePermissionRequest updatePermissionRequest, final ApiCallback<Permission> _callback) throws ApiException {

        okhttp3.Call localVarCall = updatePermissionValidateBeforeCall(permissionId, updatePermissionRequest, _callback);
        Type localVarReturnType = new TypeToken<Permission>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
