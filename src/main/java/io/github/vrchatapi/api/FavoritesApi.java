...
public class FavoritesApi {
     ...
     */
    public void updateFavoriteGroup(@javax.annotation.Nonnull FavoriteType favoriteGroupType, @javax.annotation.Nonnull String favoriteGroupName, @javax.annotation.Nonnull String userId, @javax.annotation.Nullable UpdateFavoriteGroupRequest updateFavoriteGroupRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateFavoriteGroupWithHttpInfo(@javax.annotation.Nonnull FavoriteType favoriteGroupType, @javax.annotation.Nonnull String favoriteGroupName, @javax.annotation.Nonnull String userId, @javax.annotation.Nullable UpdateFavoriteGroupRequest updateFavoriteGroupRequest) throws ApiException {
     ...
     */
    public okhttp3.Call updateFavoriteGroupAsync(@javax.annotation.Nonnull FavoriteType favoriteGroupType, @javax.annotation.Nonnull String favoriteGroupName, @javax.annotation.Nonnull String userId, @javax.annotation.Nullable UpdateFavoriteGroupRequest updateFavoriteGroupRequest, final ApiCallback<Void> _callback) throws ApiException {
