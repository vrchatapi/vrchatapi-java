...
public class EconomyApi {
    ...
    /**
     * Build call for getAdminTransaction
     ...
     */
    @Deprecated
    public okhttp3.Call getAdminTransactionCall(String transactionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/Admin/transactions/{transactionId}"
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAdminTransactionValidateBeforeCall(String transactionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'transactionId' is set
        if (transactionId == null) {
            throw new ApiException("Missing the required parameter 'transactionId' when calling getAdminTransaction(Async)");
        }

        return getAdminTransactionCall(transactionId, _callback);
     ...
     */
    @Deprecated
    public Transaction getAdminTransaction(String transactionId) throws ApiException {
        ApiResponse<Transaction> localVarResp = getAdminTransactionWithHttpInfo(transactionId);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<Transaction> getAdminTransactionWithHttpInfo(String transactionId) throws ApiException {
        okhttp3.Call localVarCall = getAdminTransactionValidateBeforeCall(transactionId, null);
        Type localVarReturnType = new TypeToken<Transaction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Admin Transactions (asynchronously)
     * Get a single Admin transactions by ID. This returns the exact same information as &#x60;getAdminTransactions&#x60;, so no point in using this endpoint.
     * @param transactionId Must be a valid transaction ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    @Deprecated
    public okhttp3.Call getAdminTransactionAsync(String transactionId, final ApiCallback<Transaction> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAdminTransactionValidateBeforeCall(transactionId, _callback);
        Type localVarReturnType = new TypeToken<Transaction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAdminTransactions
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getAdminTransactionsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/Admin/transactions";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAdminTransactionsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getAdminTransactionsCall(_callback);
     ...
     */
    public List<Transaction> getAdminTransactions() throws ApiException {
        ApiResponse<List<Transaction>> localVarResp = getAdminTransactionsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Transaction>> getAdminTransactionsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAdminTransactionsValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getAdminTransactionsAsync(final ApiCallback<List<Transaction>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAdminTransactionsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<List<Transaction>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
