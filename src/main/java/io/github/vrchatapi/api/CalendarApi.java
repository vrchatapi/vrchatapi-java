...
public class CalendarApi {
     ...
     */
    public CalendarEventDiscovery discoverCalendarEvents(CalendarEventDiscoveryScope scope, String categories, String tags, CalendarEventDiscoveryInclusion featuredResults, CalendarEventDiscoveryInclusion nonFeaturedResults, CalendarEventDiscoveryInclusion personalizedResults, Integer minimumInterestCount, Integer minimumRemainingMinutes, Integer upcomingOffsetMinutes, Integer n, String nextCursor) throws ApiException {
     ...
     */
    public okhttp3.Call discoverCalendarEventsAsync(CalendarEventDiscoveryScope scope, String categories, String tags, CalendarEventDiscoveryInclusion featuredResults, CalendarEventDiscoveryInclusion nonFeaturedResults, CalendarEventDiscoveryInclusion personalizedResults, Integer minimumInterestCount, Integer minimumRemainingMinutes, Integer upcomingOffsetMinutes, Integer n, String nextCursor, final ApiCallback<CalendarEventDiscovery> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getGroupNextCalendarEventCall(String groupId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGroupNextCalendarEventValidateBeforeCall(String groupId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
     ...
     */
    public CalendarEvent getGroupNextCalendarEvent(String groupId) throws ApiException {
     ...
     */
    public ApiResponse<CalendarEvent> getGroupNextCalendarEventWithHttpInfo(String groupId) throws ApiException {
     ...
     */
    public okhttp3.Call getGroupNextCalendarEventAsync(String groupId, final ApiCallback<CalendarEvent> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call searchCalendarEventsCall(String searchTerm, Integer utcOffset, Integer n, Integer offset, Boolean isInternalVariant, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchCalendarEventsValidateBeforeCall(String searchTerm, Integer utcOffset, Integer n, Integer offset, Boolean isInternalVariant, final ApiCallback _callback) throws ApiException {
     ...
     */
    public PaginatedCalendarEventList searchCalendarEvents(String searchTerm, Integer utcOffset, Integer n, Integer offset, Boolean isInternalVariant) throws ApiException {
     ...
     */
    public ApiResponse<PaginatedCalendarEventList> searchCalendarEventsWithHttpInfo(String searchTerm, Integer utcOffset, Integer n, Integer offset, Boolean isInternalVariant) throws ApiException {
     ...
     */
    public okhttp3.Call searchCalendarEventsAsync(String searchTerm, Integer utcOffset, Integer n, Integer offset, Boolean isInternalVariant, final ApiCallback<PaginatedCalendarEventList> _callback) throws ApiException {
