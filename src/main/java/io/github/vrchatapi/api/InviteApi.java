...
import io.github.vrchatapi.model.InviteMyselfToRequest;
...
public class InviteApi {
     ...
     * @param inviteMyselfToRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call inviteMyselfToCall(String worldId, String instanceId, InviteMyselfToRequest inviteMyselfToRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = inviteMyselfToRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call inviteMyselfToValidateBeforeCall(String worldId, String instanceId, InviteMyselfToRequest inviteMyselfToRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = inviteMyselfToCall(worldId, instanceId, inviteMyselfToRequest, _callback);
        return localVarCall;
     ...
     */
    public SentNotification inviteMyselfTo(String worldId, String instanceId, InviteMyselfToRequest inviteMyselfToRequest) throws ApiException {
        ApiResponse<SentNotification> localVarResp = inviteMyselfToWithHttpInfo(worldId, instanceId, inviteMyselfToRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SentNotification> inviteMyselfToWithHttpInfo(String worldId, String instanceId, InviteMyselfToRequest inviteMyselfToRequest) throws ApiException {
        okhttp3.Call localVarCall = inviteMyselfToValidateBeforeCall(worldId, instanceId, inviteMyselfToRequest, null);
     ...
     */
    public okhttp3.Call inviteMyselfToAsync(String worldId, String instanceId, InviteMyselfToRequest inviteMyselfToRequest, final ApiCallback<SentNotification> _callback) throws ApiException {

        okhttp3.Call localVarCall = inviteMyselfToValidateBeforeCall(worldId, instanceId, inviteMyselfToRequest, _callback);
        Type localVarReturnType = new TypeToken<SentNotification>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
