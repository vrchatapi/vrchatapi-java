...
public class PlayermoderationApi {
     ...
     * @param sourceUserId Must be valid UserID. Trying to view someone else&#39;s moderations results with \&quot;Can&#39;t view someone else&#39;s player moderations\&quot; error. (optional)
     ...
     */
    public okhttp3.Call getPlayerModerationsCall(PlayerModerationType type, String sourceUserId, String targetUserId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (sourceUserId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("sourceUserId", sourceUserId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPlayerModerationsValidateBeforeCall(PlayerModerationType type, String sourceUserId, String targetUserId, final ApiCallback _callback) throws ApiException {
        return getPlayerModerationsCall(type, sourceUserId, targetUserId, _callback);
     ...
     */
    public List<PlayerModeration> getPlayerModerations(PlayerModerationType type, String sourceUserId, String targetUserId) throws ApiException {
        ApiResponse<List<PlayerModeration>> localVarResp = getPlayerModerationsWithHttpInfo(type, sourceUserId, targetUserId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<PlayerModeration>> getPlayerModerationsWithHttpInfo(PlayerModerationType type, String sourceUserId, String targetUserId) throws ApiException {
        okhttp3.Call localVarCall = getPlayerModerationsValidateBeforeCall(type, sourceUserId, targetUserId, null);
     ...
     */
    public okhttp3.Call getPlayerModerationsAsync(PlayerModerationType type, String sourceUserId, String targetUserId, final ApiCallback<List<PlayerModeration>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPlayerModerationsValidateBeforeCall(type, sourceUserId, targetUserId, _callback);
        Type localVarReturnType = new TypeToken<List<PlayerModeration>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
