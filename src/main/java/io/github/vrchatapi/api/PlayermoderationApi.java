...
public class PlayermoderationApi {
     ...
     */
    public Success unmoderateUser(InlineObject13 inlineObject13) throws ApiException {
        ApiResponse<Success> localVarResp = unmoderateUserWithHttpInfo(inlineObject13);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Success> unmoderateUserWithHttpInfo(InlineObject13 inlineObject13) throws ApiException {
     ...
     */
    public okhttp3.Call unmoderateUserAsync(InlineObject13 inlineObject13, final ApiCallback<Success> _callback) throws ApiException {
