...
public class CreatePermissionRequest {
  ...
  **/
  ...
  public CreatePermissionRequest ownerId(String ownerId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createPermissionRequest.name) &&
        Objects.equals(this.ownerId, createPermissionRequest.ownerId);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePermissionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePermissionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreatePermissionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePermissionRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
