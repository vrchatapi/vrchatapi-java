...
public class GroupLimitedMember {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, groupId, userId, isRepresenting, roleIds, mRoleIds, joinedAt, membershipStatus, visibility, isSubscribedToAnnouncements, isSubscribedToEventAnnouncements, createdAt, bannedAt, managerNotes, lastPostReadAt, hasJoinedFromPurchase);
  }
