...
public class Instance {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, canRequestInvite, capacity, clientNumber, full, id, instanceId, location, nUsers, name, ownerId, permanent, photonRegion, platforms, region, secureName, shortName, tags, type, worldId, hidden, friends, _private, queueEnabled, queueSize, recommendedCapacity, roleRestricted, strict, userCount, world, users);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("roleRestricted");
