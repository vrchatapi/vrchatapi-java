...
public class Instance {
  ...
  private List<LimitedUserInstance> users = null;
  ...
  **/
  ...
  public Instance calendarEntryId(String calendarEntryId) {
  ...
  **/
  ...
  public Instance instancePersistenceEnabled(Boolean instancePersistenceEnabled) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "[\"language_eng\",\"language_jpn\",\"show_social_rank\"]", required = true, value = "The tags array on Instances usually contain the language tags of the people in the instance. ")
  ...
  **/
  ...
  public Instance users(List<LimitedUserInstance> users) {
  ...
  **/
  ...
  public void setUsers(List<LimitedUserInstance> users) {
    this.users = users;
  }
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("calendarEntryId");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("calendarEntryId") != null && !jsonObj.get("calendarEntryId").isJsonNull()) && !jsonObj.get("calendarEntryId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `calendarEntryId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("calendarEntryId").toString()));
      }
      ...
      if (jsonObj.get("users") != null && !jsonObj.get("users").isJsonNull()) {
        ...
        if (jsonArrayusers != null) {
          ...
          for (int i = 0; i < jsonArrayusers.size(); i++) {
            LimitedUserInstance.validateJsonObject(jsonArrayusers.get(i).getAsJsonObject());
          };
        }
      }
