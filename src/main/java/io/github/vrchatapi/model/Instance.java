...
public class Instance {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "wrld_ba913a96-fac4-4048-a062-9aa5db092812:12345~hidden(usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469)~region(eu)~nonce(27e8414a-59a0-4f3d-af1f-f27557eb49a2)", required = true, value = "InstanceID be \"offline\" on User profiles if you are not friends with that user.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "fortran-grublink-41d83", required = true, value = "")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, canRequestInvite, capacity, clientNumber, full, id, instanceId, location, nUsers, name, ownerId, permanent, photonRegion, platforms, region, shortName, tags, type, worldId, hidden, friends, _private);
  }
