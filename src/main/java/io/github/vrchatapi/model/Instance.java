...
public class Instance {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("instancePersistenceEnabled") != null && !jsonObj.get("instancePersistenceEnabled").isJsonNull()) && !jsonObj.get("instancePersistenceEnabled").isJsonPrimitive()) {
