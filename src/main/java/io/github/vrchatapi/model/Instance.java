...
public class Instance {
  ...
  private String playerPersistenceEnabled;
  ...
  **/
  ...
  public Instance playerPersistenceEnabled(String playerPersistenceEnabled) {
  ...
  **/
  ...
  public String getPlayerPersistenceEnabled() {
    return playerPersistenceEnabled;
  }


  public void setPlayerPersistenceEnabled(String playerPersistenceEnabled) {
    this.playerPersistenceEnabled = playerPersistenceEnabled;
  }
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("gameServerVersion");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("playerPersistenceEnabled").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `playerPersistenceEnabled` to be a primitive type in the JSON string but got `%s`", jsonObj.get("playerPersistenceEnabled").toString()));
      }
