...
public class Instance {
  ...
  **/
  ...
  public Instance ageGate(String ageGate) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("ageGate") != null && !jsonObj.get("ageGate").isJsonNull()) && !jsonObj.get("ageGate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ageGate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ageGate").toString()));
      }
