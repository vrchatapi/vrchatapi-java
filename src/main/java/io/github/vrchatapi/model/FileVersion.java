...
public class FileVersion {
  ...
  public FileVersion version(BigDecimal version) {
  ...
  **/
  ...
  @ApiModelProperty(example = "0", required = true, value = "Incremental version counter, can only be increased.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, status, createdAt, file, delta, signature, deleted);
  }
