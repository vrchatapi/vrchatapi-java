...
public class WorldPublishStatus {
  ...
  public WorldPublishStatus canPublish(@javax.annotation.Nonnull Boolean canPublish) {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("canPublish"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorldPublishStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorldPublishStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WorldPublishStatus is not found in the empty JSON string", WorldPublishStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorldPublishStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WorldPublishStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
