...
public class GroupMember {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acceptedByDisplayName, acceptedById, id, groupId, userId, isRepresenting, user, roleIds, mRoleIds, joinedAt, membershipStatus, visibility, isSubscribedToAnnouncements, createdAt, bannedAt, managerNotes, lastPostReadAt, hasJoinedFromPurchase);
  }
