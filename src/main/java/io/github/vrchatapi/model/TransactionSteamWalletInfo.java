...
public class TransactionSteamWalletInfo {
  ...
  public TransactionSteamWalletInfo country(@javax.annotation.Nonnull String country) {
  ...
  public TransactionSteamWalletInfo currency(@javax.annotation.Nonnull String currency) {
  ...
  public TransactionSteamWalletInfo state(@javax.annotation.Nonnull String state) {
    this.state = state;
    return this;
  }
  ...
  public TransactionSteamWalletInfo status(@javax.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.country, transactionSteamWalletInfo.country) &&
        Objects.equals(this.currency, transactionSteamWalletInfo.currency) &&
        Objects.equals(this.state, transactionSteamWalletInfo.state) &&
        Objects.equals(this.status, transactionSteamWalletInfo.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(country, currency, state, status);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("country", "currency", "state", "status"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("country", "currency", "state", "status"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransactionSteamWalletInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionSteamWalletInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TransactionSteamWalletInfo is not found in the empty JSON string", TransactionSteamWalletInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransactionSteamWalletInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TransactionSteamWalletInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
