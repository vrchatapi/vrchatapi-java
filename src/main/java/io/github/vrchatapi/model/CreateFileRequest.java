...
public class CreateFileRequest {
  ...
  public CreateFileRequest extension(@javax.annotation.Nonnull String extension) {
  ...
  public CreateFileRequest mimeType(@javax.annotation.Nonnull MIMEType mimeType) {
  ...
  public CreateFileRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateFileRequest tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.extension, createFileRequest.extension) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(extension, mimeType, name, tags);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("extension", "mimeType", "name", "tags"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("extension", "mimeType", "name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateFileRequest is not found in the empty JSON string", CreateFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
