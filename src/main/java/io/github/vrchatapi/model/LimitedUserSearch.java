...
public class LimitedUserSearch {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bio, bioLinks, currentAvatarImageUrl, currentAvatarThumbnailImageUrl, currentAvatarTags, developerType, displayName, id, isFriend, lastPlatform, profilePicOverride, pronouns, status, statusDescription, tags, userIcon);
  }
