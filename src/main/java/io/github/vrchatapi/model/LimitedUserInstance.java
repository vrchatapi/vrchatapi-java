...
public class LimitedUserInstance {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ageVerificationStatus, ageVerified, allowAvatarCopying, bio, bioLinks, currentAvatarImageUrl, currentAvatarThumbnailImageUrl, currentAvatarTags, dateJoined, developerType, displayName, friendKey, id, isFriend, imageUrl, lastPlatform, lastActivity, lastMobile, platform, profilePicOverride, profilePicOverrideThumbnail, pronouns, state, status, statusDescription, tags, userIcon);
  }
