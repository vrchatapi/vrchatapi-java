...
public class LimitedWorld {
  ...
  **/
  ...
  public LimitedWorld defaultContentSettings(InstanceContentSettings defaultContentSettings) {
  ...
  **/
  ...
  public LimitedWorld storeId(String storeId) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorId, authorName, capacity, recommendedCapacity, createdAt, defaultContentSettings, favorites, visits, heat, id, imageUrl, labsPublicationDate, name, occupants, organization, popularity, previewYoutubeId, publicationDate, releaseStatus, storeId, tags, thumbnailImageUrl, unityPackages, updatedAt, udonProducts);
  }
