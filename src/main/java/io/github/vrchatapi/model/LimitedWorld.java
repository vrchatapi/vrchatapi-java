...
public class LimitedWorld {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorId, authorName, capacity, recommendedCapacity, createdAt, favorites, heat, id, imageUrl, labsPublicationDate, name, occupants, organization, popularity, publicationDate, releaseStatus, tags, thumbnailImageUrl, unityPackages, updatedAt, udonProducts);
  }
