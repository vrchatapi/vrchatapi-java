...
public class Avatar {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acknowledgements, assetUrl, assetUrlObject, authorId, authorName, createdAt, description, featured, highestPrice, id, imageUrl, lock, lowestPrice, name, performance, productId, publishedListings, releaseStatus, searchable, styles, tags, thumbnailImageUrl, unityPackageUrl, unityPackageUrlObject, unityPackages, updatedAt, version);
  }
