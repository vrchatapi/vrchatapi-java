...
public class Avatar {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assetUrl, assetUrlObject, authorId, authorName, createdAt, description, featured, id, imageUrl, name, releaseStatus, styles, tags, thumbnailImageUrl, unityPackageUrl, unityPackageUrlObject, unityPackages, updatedAt, version);
  }
