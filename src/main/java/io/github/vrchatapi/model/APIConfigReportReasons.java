...
public class APIConfigReportReasons {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billing, botting, cancellation, gore, hacking, harassing, hateful, impersonation, inappropriate, leaking, malicious, missing, nudity, renewal, security, service, sexual, threatening, visuals);
  }
