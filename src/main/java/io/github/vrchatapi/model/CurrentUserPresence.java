...
public class CurrentUserPresence {
  ...
  **/
  ...
  public CurrentUserPresence currentAvatarTags(List<String> currentAvatarTags) {
  ...
  **/
  ...
  public CurrentUserPresence debugflag(String debugflag) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("debugflag") != null && !jsonObj.get("debugflag").isJsonNull()) && !jsonObj.get("debugflag").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `debugflag` to be a primitive type in the JSON string but got `%s`", jsonObj.get("debugflag").toString()));
      }
