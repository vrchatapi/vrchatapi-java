...
public class CurrentUserPresence {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(avatarThumbnail, currentAvatarTags, displayName, debugflag, groups, id, instance, instanceType, isRejoining, platform, profilePicOverride, status, travelingToInstance, travelingToWorld, userIcon, world);
  }
