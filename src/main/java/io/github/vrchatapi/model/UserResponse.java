...
public class UserResponse {
  ...
  public UserResponse acceptedPrivacyVersion(@javax.annotation.Nullable Integer acceptedPrivacyVersion) {
  ...
  public UserResponse acceptedTOSVersion(@javax.annotation.Nullable Integer acceptedTOSVersion) {
  ...
  public UserResponse accountDeletionDate(@javax.annotation.Nullable String accountDeletionDate) {
  ...
  public UserResponse accountDeletionLog(@javax.annotation.Nullable List<Object> accountDeletionLog) {
    this.accountDeletionLog = accountDeletionLog;
    return this;
  }

  public UserResponse addAccountDeletionLogItem(Object accountDeletionLogItem) {
  ...
  public UserResponse ageVerificationStatus(@javax.annotation.Nonnull AgeVerificationStatus ageVerificationStatus) {
  ...
  public UserResponse ageVerified(@javax.annotation.Nonnull Boolean ageVerified) {
  ...
  public UserResponse allowAvatarCopying(@javax.annotation.Nonnull Boolean allowAvatarCopying) {
  ...
  public UserResponse appleDetails(@javax.annotation.Nullable Object appleDetails) {
  ...
  public UserResponse bannerColor(@javax.annotation.Nullable String bannerColor) {
  ...
  public UserResponse bannerType(@javax.annotation.Nullable String bannerType) {
  ...
  public UserResponse bannerUrl(@javax.annotation.Nullable String bannerUrl) {
  ...
  public UserResponse dateJoined(@javax.annotation.Nonnull LocalDate dateJoined) {
  ...
  public UserResponse developerType(@javax.annotation.Nonnull DeveloperType developerType) {
  ...
  public UserResponse displayName(@javax.annotation.Nonnull String displayName) {
  ...
  public UserResponse friendKey(@javax.annotation.Nonnull String friendKey) {
  ...
  public UserResponse friendRequestStatus(@javax.annotation.Nullable String friendRequestStatus) {
  ...
  public UserResponse iconFrame(@javax.annotation.Nullable String iconFrame) {
  ...
  public UserResponse iconUrl(@javax.annotation.Nullable String iconUrl) {
  ...
  public UserResponse instanceId(@javax.annotation.Nullable String instanceId) {
  ...
  public UserResponse isEconomyCreator(@javax.annotation.Nullable Boolean isEconomyCreator) {
  ...
  public UserResponse isFriend(@javax.annotation.Nonnull Boolean isFriend) {
  ...
  public UserResponse lastActivity(@javax.annotation.Nullable String lastActivity) {
  ...
  public UserResponse lastLogin(@javax.annotation.Nonnull String lastLogin) {
  ...
  public UserResponse lastMobile(@javax.annotation.Nullable String lastMobile) {
  ...
  public UserResponse lastPlatform(@javax.annotation.Nonnull String lastPlatform) {
  ...
  public UserResponse location(@javax.annotation.Nullable String location) {
  ...
  public UserResponse nameplateEffect(@javax.annotation.Nullable String nameplateEffect) {
  ...
  public UserResponse note(@javax.annotation.Nullable String note) {
    this.note = note;
    return this;
  }
  ...
  public UserResponse platform(@javax.annotation.Nullable String platform) {
  ...
  public UserResponse profileEffect(@javax.annotation.Nullable String profileEffect) {
  ...
  public UserResponse pronouns(@javax.annotation.Nonnull String pronouns) {
  ...
  public UserResponse state(@javax.annotation.Nonnull UserState state) {
    this.state = state;
    return this;
  }
  ...
  public UserResponse status(@javax.annotation.Nonnull UserStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UserResponse statusDescription(@javax.annotation.Nonnull String statusDescription) {
  ...
  public UserResponse tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UserResponse travelingToInstance(@javax.annotation.Nullable String travelingToInstance) {
  ...
  public UserResponse travelingToLocation(@javax.annotation.Nullable String travelingToLocation) {
  ...
  public UserResponse travelingToWorld(@javax.annotation.Nullable String travelingToWorld) {
  ...
  public UserResponse worldId(@javax.annotation.Nullable String worldId) {
  ...
  public UserResponse activeFriends(@javax.annotation.Nullable List<String> activeFriends) {
    this.activeFriends = activeFriends;
    return this;
  }

  public UserResponse addActiveFriendsItem(String activeFriendsItem) {
  ...
  public UserResponse appleId(@javax.annotation.Nullable String appleId) {
  ...
  public UserResponse authToken(@javax.annotation.Nullable String authToken) {
  ...
  public UserResponse completedTutorials(@javax.annotation.Nullable List<String> completedTutorials) {
    this.completedTutorials = completedTutorials;
    return this;
  }

  public UserResponse addCompletedTutorialsItem(String completedTutorialsItem) {
  ...
  public UserResponse contentFilters(@javax.annotation.Nullable List<String> contentFilters) {
    this.contentFilters = contentFilters;
    return this;
  }

  public UserResponse addContentFiltersItem(String contentFiltersItem) {
  ...
  public UserResponse currentAvatar(@javax.annotation.Nullable String currentAvatar) {
  ...
  public UserResponse currentAvatarImageUrl(@javax.annotation.Nullable String currentAvatarImageUrl) {
  ...
  public UserResponse currentAvatarTags(@javax.annotation.Nullable List<String> currentAvatarTags) {
    this.currentAvatarTags = currentAvatarTags;
    return this;
  }

  public UserResponse addCurrentAvatarTagsItem(String currentAvatarTagsItem) {
  ...
  public UserResponse currentAvatarThumbnailImageUrl(@javax.annotation.Nullable String currentAvatarThumbnailImageUrl) {
  ...
  public UserResponse discordDetails(@javax.annotation.Nullable DiscordDetails discordDetails) {
  ...
  public UserResponse discordId(@javax.annotation.Nullable String discordId) {
  ...
  public UserResponse emailVerified(@javax.annotation.Nullable Boolean emailVerified) {
  ...
  public UserResponse fallbackAvatar(@javax.annotation.Nullable String fallbackAvatar) {
  ...
  @Deprecated
  public UserResponse friendGroupNames(@javax.annotation.Nullable List<String> friendGroupNames) {
    this.friendGroupNames = friendGroupNames;
    return this;
  }

  public UserResponse addFriendGroupNamesItem(String friendGroupNamesItem) {
  ...
  public UserResponse friends(@javax.annotation.Nullable List<String> friends) {
    this.friends = friends;
    return this;
  }

  public UserResponse addFriendsItem(String friendsItem) {
  ...
  public UserResponse googleDetails(@javax.annotation.Nullable Object googleDetails) {
  ...
  public UserResponse googleId(@javax.annotation.Nullable String googleId) {
  ...
  public UserResponse hasBirthday(@javax.annotation.Nullable Boolean hasBirthday) {
  ...
  public UserResponse hasDiscordFriendsOptOut(@javax.annotation.Nullable Boolean hasDiscordFriendsOptOut) {
  ...
  public UserResponse hasEmail(@javax.annotation.Nullable Boolean hasEmail) {
  ...
  public UserResponse hasLoggedInFromClient(@javax.annotation.Nullable Boolean hasLoggedInFromClient) {
  ...
  public UserResponse hasPendingEmail(@javax.annotation.Nullable Boolean hasPendingEmail) {
  ...
  public UserResponse hasSharedConnectionsOptOut(@javax.annotation.Nullable Boolean hasSharedConnectionsOptOut) {
  ...
  public UserResponse hideContentFilterSettings(@javax.annotation.Nullable Boolean hideContentFilterSettings) {
  ...
  public UserResponse homeLocation(@javax.annotation.Nullable String homeLocation) {
  ...
  public UserResponse isAdult(@javax.annotation.Nullable Boolean isAdult) {
  ...
  public UserResponse isBoopingEnabled(@javax.annotation.Nullable Boolean isBoopingEnabled) {
  ...
  public UserResponse isTemporary(@javax.annotation.Nullable Boolean isTemporary) {
  ...
  public UserResponse obfuscatedEmail(@javax.annotation.Nullable String obfuscatedEmail) {
  ...
  public UserResponse obfuscatedPendingEmail(@javax.annotation.Nullable String obfuscatedPendingEmail) {
  ...
  public UserResponse oculusId(@javax.annotation.Nullable String oculusId) {
  ...
  public UserResponse offlineFriends(@javax.annotation.Nullable List<String> offlineFriends) {
    this.offlineFriends = offlineFriends;
    return this;
  }

  public UserResponse addOfflineFriendsItem(String offlineFriendsItem) {
  ...
  public UserResponse onlineFriends(@javax.annotation.Nullable List<String> onlineFriends) {
    this.onlineFriends = onlineFriends;
    return this;
  }

  public UserResponse addOnlineFriendsItem(String onlineFriendsItem) {
  ...
  public UserResponse pastDisplayNames(@javax.annotation.Nullable List<PastDisplayName> pastDisplayNames) {
    this.pastDisplayNames = pastDisplayNames;
    return this;
  }

  public UserResponse addPastDisplayNamesItem(PastDisplayName pastDisplayNamesItem) {
  ...
  public UserResponse personalizationOptOut(@javax.annotation.Nullable Boolean personalizationOptOut) {
  ...
  public UserResponse picoId(@javax.annotation.Nullable String picoId) {
    this.picoId = picoId;
    return this;
  }
  ...
  public UserResponse platformHistory(@javax.annotation.Nullable List<PlatformHistoryEntry> platformHistory) {
    this.platformHistory = platformHistory;
    return this;
  }

  public UserResponse addPlatformHistoryItem(PlatformHistoryEntry platformHistoryItem) {
  ...
  public UserResponse presence(@javax.annotation.Nullable CurrentUserPresence presence) {
  ...
  public UserResponse pronounsHistory(@javax.annotation.Nullable List<String> pronounsHistory) {
    this.pronounsHistory = pronounsHistory;
    return this;
  }

  public UserResponse addPronounsHistoryItem(String pronounsHistoryItem) {
  ...
  public UserResponse queuedInstance(@javax.annotation.Nullable String queuedInstance) {
  ...
  public UserResponse receiveMobileInvitations(@javax.annotation.Nullable Boolean receiveMobileInvitations) {
  ...
  public UserResponse statusFirstTime(@javax.annotation.Nullable Boolean statusFirstTime) {
  ...
  public UserResponse statusHistory(@javax.annotation.Nullable List<String> statusHistory) {
    this.statusHistory = statusHistory;
    return this;
  }

  public UserResponse addStatusHistoryItem(String statusHistoryItem) {
  ...
  public UserResponse steamDetails(@javax.annotation.Nullable Object steamDetails) {
  ...
  public UserResponse steamId(@javax.annotation.Nullable String steamId) {
  ...
  public UserResponse temporaryExpiryDate(@javax.annotation.Nullable Object temporaryExpiryDate) {
  ...
  public UserResponse twitchDetails(@javax.annotation.Nullable Object twitchDetails) {
  ...
  public UserResponse twitchId(@javax.annotation.Nullable String twitchId) {
  ...
  public UserResponse twoFactorAuthEnabled(@javax.annotation.Nullable Boolean twoFactorAuthEnabled) {
  ...
  public UserResponse twoFactorAuthEnabledDate(@javax.annotation.Nullable OffsetDateTime twoFactorAuthEnabledDate) {
  ...
  public UserResponse unsubscribe(@javax.annotation.Nullable Boolean unsubscribe) {
  ...
  public UserResponse userLanguage(@javax.annotation.Nullable String userLanguage) {
  ...
  public UserResponse userLanguageCode(@javax.annotation.Nullable String userLanguageCode) {
  ...
  public UserResponse username(@javax.annotation.Nullable String username) {
  ...
  public UserResponse usesGeneratedPassword(@javax.annotation.Nullable Boolean usesGeneratedPassword) {
  ...
  public UserResponse viveId(@javax.annotation.Nullable String viveId) {
    this.viveId = viveId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acceptedPrivacyVersion, userResponse.acceptedPrivacyVersion) &&
        Objects.equals(this.acceptedTOSVersion, userResponse.acceptedTOSVersion) &&
        Objects.equals(this.accountDeletionDate, userResponse.accountDeletionDate) &&
        Objects.equals(this.accountDeletionLog, userResponse.accountDeletionLog) &&
        Objects.equals(this.ageVerificationStatus, userResponse.ageVerificationStatus) &&
        Objects.equals(this.ageVerified, userResponse.ageVerified) &&
        Objects.equals(this.allowAvatarCopying, userResponse.allowAvatarCopying) &&
        Objects.equals(this.appleDetails, userResponse.appleDetails) &&
        Objects.equals(this.bannerColor, userResponse.bannerColor) &&
        Objects.equals(this.bannerType, userResponse.bannerType) &&
        Objects.equals(this.bannerUrl, userResponse.bannerUrl) &&
        Objects.equals(this.dateJoined, userResponse.dateJoined) &&
        Objects.equals(this.developerType, userResponse.developerType) &&
        Objects.equals(this.displayName, userResponse.displayName) &&
        Objects.equals(this.friendKey, userResponse.friendKey) &&
        Objects.equals(this.friendRequestStatus, userResponse.friendRequestStatus) &&
        Objects.equals(this.iconFrame, userResponse.iconFrame) &&
        Objects.equals(this.iconUrl, userResponse.iconUrl) &&
        Objects.equals(this.id, userResponse.id) &&
        Objects.equals(this.instanceId, userResponse.instanceId) &&
        Objects.equals(this.isEconomyCreator, userResponse.isEconomyCreator) &&
        Objects.equals(this.isFriend, userResponse.isFriend) &&
        Objects.equals(this.lastActivity, userResponse.lastActivity) &&
        Objects.equals(this.lastLogin, userResponse.lastLogin) &&
        Objects.equals(this.lastMobile, userResponse.lastMobile) &&
        Objects.equals(this.lastPlatform, userResponse.lastPlatform) &&
        Objects.equals(this.location, userResponse.location) &&
        Objects.equals(this.nameplateEffect, userResponse.nameplateEffect) &&
        Objects.equals(this.note, userResponse.note) &&
        Objects.equals(this.platform, userResponse.platform) &&
        Objects.equals(this.profileEffect, userResponse.profileEffect) &&
        Objects.equals(this.pronouns, userResponse.pronouns) &&
        Objects.equals(this.state, userResponse.state) &&
        Objects.equals(this.status, userResponse.status) &&
        Objects.equals(this.statusDescription, userResponse.statusDescription) &&
        Objects.equals(this.tags, userResponse.tags) &&
        Objects.equals(this.travelingToInstance, userResponse.travelingToInstance) &&
        Objects.equals(this.travelingToLocation, userResponse.travelingToLocation) &&
        Objects.equals(this.travelingToWorld, userResponse.travelingToWorld) &&
        Objects.equals(this.worldId, userResponse.worldId) &&
        Objects.equals(this.activeFriends, userResponse.activeFriends) &&
        Objects.equals(this.appleId, userResponse.appleId) &&
        Objects.equals(this.authToken, userResponse.authToken) &&
        Objects.equals(this.completedTutorials, userResponse.completedTutorials) &&
        Objects.equals(this.contentFilters, userResponse.contentFilters) &&
        Objects.equals(this.currentAvatar, userResponse.currentAvatar) &&
        Objects.equals(this.currentAvatarImageUrl, userResponse.currentAvatarImageUrl) &&
        Objects.equals(this.currentAvatarTags, userResponse.currentAvatarTags) &&
        Objects.equals(this.currentAvatarThumbnailImageUrl, userResponse.currentAvatarThumbnailImageUrl) &&
        Objects.equals(this.discordDetails, userResponse.discordDetails) &&
        Objects.equals(this.discordId, userResponse.discordId) &&
        Objects.equals(this.emailVerified, userResponse.emailVerified) &&
        Objects.equals(this.fallbackAvatar, userResponse.fallbackAvatar) &&
        Objects.equals(this.friendGroupNames, userResponse.friendGroupNames) &&
        Objects.equals(this.friends, userResponse.friends) &&
        Objects.equals(this.googleDetails, userResponse.googleDetails) &&
        Objects.equals(this.googleId, userResponse.googleId) &&
        Objects.equals(this.hasBirthday, userResponse.hasBirthday) &&
        Objects.equals(this.hasDiscordFriendsOptOut, userResponse.hasDiscordFriendsOptOut) &&
        Objects.equals(this.hasEmail, userResponse.hasEmail) &&
        Objects.equals(this.hasLoggedInFromClient, userResponse.hasLoggedInFromClient) &&
        Objects.equals(this.hasPendingEmail, userResponse.hasPendingEmail) &&
        Objects.equals(this.hasSharedConnectionsOptOut, userResponse.hasSharedConnectionsOptOut) &&
        Objects.equals(this.hideContentFilterSettings, userResponse.hideContentFilterSettings) &&
        Objects.equals(this.homeLocation, userResponse.homeLocation) &&
        Objects.equals(this.isAdult, userResponse.isAdult) &&
        Objects.equals(this.isBoopingEnabled, userResponse.isBoopingEnabled) &&
        Objects.equals(this.isTemporary, userResponse.isTemporary) &&
        Objects.equals(this.obfuscatedEmail, userResponse.obfuscatedEmail) &&
        Objects.equals(this.obfuscatedPendingEmail, userResponse.obfuscatedPendingEmail) &&
        Objects.equals(this.oculusId, userResponse.oculusId) &&
        Objects.equals(this.offlineFriends, userResponse.offlineFriends) &&
        Objects.equals(this.onlineFriends, userResponse.onlineFriends) &&
        Objects.equals(this.pastDisplayNames, userResponse.pastDisplayNames) &&
        Objects.equals(this.personalizationOptOut, userResponse.personalizationOptOut) &&
        Objects.equals(this.picoId, userResponse.picoId) &&
        Objects.equals(this.platformHistory, userResponse.platformHistory) &&
        Objects.equals(this.presence, userResponse.presence) &&
        Objects.equals(this.pronounsHistory, userResponse.pronounsHistory) &&
        Objects.equals(this.queuedInstance, userResponse.queuedInstance) &&
        Objects.equals(this.receiveMobileInvitations, userResponse.receiveMobileInvitations) &&
        Objects.equals(this.statusFirstTime, userResponse.statusFirstTime) &&
        Objects.equals(this.statusHistory, userResponse.statusHistory) &&
        Objects.equals(this.steamDetails, userResponse.steamDetails) &&
        Objects.equals(this.steamId, userResponse.steamId) &&
        Objects.equals(this.temporaryExpiryDate, userResponse.temporaryExpiryDate) &&
        Objects.equals(this.twitchDetails, userResponse.twitchDetails) &&
        Objects.equals(this.twitchId, userResponse.twitchId) &&
        Objects.equals(this.twoFactorAuthEnabled, userResponse.twoFactorAuthEnabled) &&
        Objects.equals(this.twoFactorAuthEnabledDate, userResponse.twoFactorAuthEnabledDate) &&
        Objects.equals(this.unsubscribe, userResponse.unsubscribe) &&
        Objects.equals(this.updatedAt, userResponse.updatedAt) &&
        Objects.equals(this.userLanguage, userResponse.userLanguage) &&
        Objects.equals(this.userLanguageCode, userResponse.userLanguageCode) &&
        Objects.equals(this.username, userResponse.username) &&
        Objects.equals(this.usesGeneratedPassword, userResponse.usesGeneratedPassword) &&
        Objects.equals(this.viveId, userResponse.viveId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acceptedPrivacyVersion, acceptedTOSVersion, accountDeletionDate, accountDeletionLog, ageVerificationStatus, ageVerified, allowAvatarCopying, appleDetails, bannerColor, bannerType, bannerUrl, dateJoined, developerType, displayName, friendKey, friendRequestStatus, iconFrame, iconUrl, id, instanceId, isEconomyCreator, isFriend, lastActivity, lastLogin, lastMobile, lastPlatform, location, nameplateEffect, note, platform, profileEffect, pronouns, state, status, statusDescription, tags, travelingToInstance, travelingToLocation, travelingToWorld, worldId, activeFriends, appleId, authToken, completedTutorials, contentFilters, currentAvatar, currentAvatarImageUrl, currentAvatarTags, currentAvatarThumbnailImageUrl, discordDetails, discordId, emailVerified, fallbackAvatar, friendGroupNames, friends, googleDetails, googleId, hasBirthday, hasDiscordFriendsOptOut, hasEmail, hasLoggedInFromClient, hasPendingEmail, hasSharedConnectionsOptOut, hideContentFilterSettings, homeLocation, isAdult, isBoopingEnabled, isTemporary, obfuscatedEmail, obfuscatedPendingEmail, oculusId, offlineFriends, onlineFriends, pastDisplayNames, personalizationOptOut, picoId, platformHistory, presence, pronounsHistory, queuedInstance, receiveMobileInvitations, statusFirstTime, statusHistory, steamDetails, steamId, temporaryExpiryDate, twitchDetails, twitchId, twoFactorAuthEnabled, twoFactorAuthEnabledDate, unsubscribe, updatedAt, userLanguage, userLanguageCode, username, usesGeneratedPassword, viveId);
  }
