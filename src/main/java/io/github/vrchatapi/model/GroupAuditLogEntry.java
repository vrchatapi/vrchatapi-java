...
public class GroupAuditLogEntry {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"description\":{\"new\":\"My exciting new group. It's pretty nifty!\",\"old\":\"My exciting new group.  It's pretty nifty!\"},\"joinState\":{\"new\":\"request\",\"old\":\"closed\"}}", value = "The data associated with the event. The format of this data is dependent on the event type.")
