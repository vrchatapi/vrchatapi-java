...
public class GroupRoleTemplateValuesRoles {
  ...
  public GroupRoleTemplateValuesRoles name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GroupRoleTemplateValuesRoles description(@javax.annotation.Nullable String description) {
  ...
  public GroupRoleTemplateValuesRoles basePermissions(@javax.annotation.Nullable List<GroupPermissions> basePermissions) {
  ...
  public void setBasePermissions(@javax.annotation.Nullable List<GroupPermissions> basePermissions) {
    this.basePermissions = basePermissions;
  }


  public GroupRoleTemplateValuesRoles isAddedOnJoin(@javax.annotation.Nullable Boolean isAddedOnJoin) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "basePermissions", "isAddedOnJoin"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroupRoleTemplateValuesRoles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupRoleTemplateValuesRoles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GroupRoleTemplateValuesRoles is not found in the empty JSON string", GroupRoleTemplateValuesRoles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroupRoleTemplateValuesRoles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GroupRoleTemplateValuesRoles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("basePermissions") != null && !jsonObj.get("basePermissions").isJsonNull() && !jsonObj.get("basePermissions").isJsonArray()) {
