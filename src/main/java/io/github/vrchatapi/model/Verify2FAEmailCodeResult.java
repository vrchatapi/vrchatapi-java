...
public class Verify2FAEmailCodeResult {
  ...
  public Verify2FAEmailCodeResult verified(@javax.annotation.Nonnull Boolean verified) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to Verify2FAEmailCodeResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Verify2FAEmailCodeResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Verify2FAEmailCodeResult is not found in the empty JSON string", Verify2FAEmailCodeResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Verify2FAEmailCodeResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Verify2FAEmailCodeResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
