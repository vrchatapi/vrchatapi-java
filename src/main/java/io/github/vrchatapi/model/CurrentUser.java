...
public class CurrentUser {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acceptedTOSVersion, accountDeletionDate, activeFriends, allowAvatarCopying, bio, bioLinks, currentAvatar, currentAvatarAssetUrl, currentAvatarImageUrl, currentAvatarThumbnailImageUrl, dateJoined, developerType, displayName, emailVerified, fallbackAvatar, friendGroupNames, friendKey, friends, hasBirthday, hasEmail, hasLoggedInFromClient, hasPendingEmail, homeLocation, id, isFriend, lastLogin, lastPlatform, obfuscatedEmail, obfuscatedPendingEmail, oculusId, offlineFriends, onlineFriends, pastDisplayNames, profilePicOverride, state, status, statusDescription, statusFirstTime, statusHistory, steamDetails, steamId, tags, twoFactorAuthEnabled, twoFactorAuthEnabledDate, unsubscribe, userIcon, username);
  }
