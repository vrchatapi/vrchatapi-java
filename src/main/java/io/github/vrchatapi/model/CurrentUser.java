...
public class CurrentUser {
  ...
  **/
  ...
  public CurrentUser ageVerificationStatus(String ageVerificationStatus) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("ageVerificationStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ageVerificationStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ageVerificationStatus").toString()));
      }
