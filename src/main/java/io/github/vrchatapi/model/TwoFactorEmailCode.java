...
public class TwoFactorEmailCode {
  ...
  public TwoFactorEmailCode code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TwoFactorEmailCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TwoFactorEmailCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TwoFactorEmailCode is not found in the empty JSON string", TwoFactorEmailCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TwoFactorEmailCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TwoFactorEmailCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
