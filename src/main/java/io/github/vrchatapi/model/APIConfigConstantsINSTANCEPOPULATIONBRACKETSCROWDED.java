...
public class APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED {
  ...
  public APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED max(@javax.annotation.Nullable Integer max) {
    this.max = max;
    return this;
  }
  ...
  public APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED min(@javax.annotation.Nullable Integer min) {
    this.min = min;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED is not found in the empty JSON string", APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
