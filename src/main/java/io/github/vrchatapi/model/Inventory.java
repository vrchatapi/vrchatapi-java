...
public class Inventory {
  ...
  private List<InventoryItem> data = new ArrayList<>();
  ...
  public Inventory data(@javax.annotation.Nonnull List<InventoryItem> data) {
    this.data = data;
    return this;
  }

  public Inventory addDataItem(InventoryItem dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nonnull List<InventoryItem> data) {
    this.data = data;
  }


  public Inventory totalCount(@javax.annotation.Nonnull Integer totalCount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, inventory.data) &&
        Objects.equals(this.totalCount, inventory.totalCount);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data", "totalCount"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("data", "totalCount"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null) {
        ...
        for (int i = 0; i < jsonArraydata.size(); i++) {
          InventoryItem.validateJsonElement(jsonArraydata.get(i));
        }
      }
  }
