...
public class Inventory {
  ...
  public Inventory data(List<InventoryItem> data) {
  ...
  **/
  ...
  public Inventory totalCount(Integer totalCount) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Inventory.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        InventoryItem.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
