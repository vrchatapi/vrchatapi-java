...
public class User {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ageVerificationStatus, ageVerified, allowAvatarCopying, badges, bio, bioLinks, currentAvatarImageUrl, currentAvatarTags, currentAvatarThumbnailImageUrl, dateJoined, developerType, displayName, friendKey, friendRequestStatus, id, instanceId, isFriend, lastActivity, lastLogin, lastMobile, lastPlatform, location, note, platform, profilePicOverride, profilePicOverrideThumbnail, pronouns, state, status, statusDescription, tags, travelingToInstance, travelingToLocation, travelingToWorld, userIcon, username, worldId);
  }
