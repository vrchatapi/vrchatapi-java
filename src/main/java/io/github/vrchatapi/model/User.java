...
public class User {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowAvatarCopying, badges, bio, bioLinks, currentAvatarImageUrl, currentAvatarThumbnailImageUrl, currentAvatarTags, dateJoined, developerType, displayName, friendKey, friendRequestStatus, id, instanceId, isFriend, lastActivity, lastLogin, lastPlatform, location, note, profilePicOverride, pronouns, state, status, statusDescription, tags, travelingToInstance, travelingToLocation, travelingToWorld, userIcon, username, worldId);
  }
