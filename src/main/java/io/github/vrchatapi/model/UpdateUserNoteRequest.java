...
public class UpdateUserNoteRequest {
  ...
  public UpdateUserNoteRequest note(@javax.annotation.Nonnull String note) {
    this.note = note;
    return this;
  }
  ...
  public UpdateUserNoteRequest targetUserId(@javax.annotation.Nonnull String targetUserId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("note", "targetUserId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("note", "targetUserId"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserNoteRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserNoteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateUserNoteRequest is not found in the empty JSON string", UpdateUserNoteRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserNoteRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateUserNoteRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
