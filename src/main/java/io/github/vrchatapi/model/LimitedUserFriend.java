...
public class LimitedUserFriend {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bannerColor, bannerType, bannerUrl, currentAvatarImageUrl, developerType, discordId, displayName, friendKey, iconFrame, iconUrl, id, isFriend, lastActivity, lastLogin, lastMobile, lastPlatform, location, nameplateEffect, platform, profileEffect, status, statusDescription, tags);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("bannerColor", "bannerType", "bannerUrl", "currentAvatarImageUrl", "developerType", "discordId", "displayName", "friendKey", "iconFrame", "iconUrl", "id", "isFriend", "last_activity", "last_login", "last_mobile", "last_platform", "location", "nameplateEffect", "platform", "profileEffect", "status", "statusDescription", "tags"));
