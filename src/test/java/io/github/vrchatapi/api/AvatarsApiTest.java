...
public class AvatarsApiTest {
     ...
     */
    @Test
    public void createAvatarTest() throws ApiException {
        InlineObject10 inlineObject10 = null;
        Avatar response = api.createAvatar(inlineObject10);
    ...
    public void deleteAvatarTest() throws ApiException {
        ...
        Avatar response = api.deleteAvatar(avatarId);
    ...
    public void getAvatarTest() throws ApiException {
        String avatarId = null;
        Avatar response = api.getAvatar(avatarId);
     ...
     */
    @Test
    public void getFavoritedAvatarsTest() throws ApiException {
     ...
     */
    @Test
    public void searchAvatarsTest() throws ApiException {
        String featured = null;
        String sort = null;
        String user = null;
        String userId = null;
        ...
        String minUnityVersion = null;
        String platform = null;
        List<Avatar> response = api.searchAvatars(featured, sort, user, userId, n, order, offset, tag, notag, releaseStatus, maxUnityVersion, minUnityVersion, platform);
     ...
     */
    @Test
    public void selectAvatarTest() throws ApiException {
        String avatarId = null;
        CurrentUser response = api.selectAvatar(avatarId);
    ...
    public void updateAvatarTest() throws ApiException {
        ...
        Avatar response = api.updateAvatar(avatarId, inlineObject11);
