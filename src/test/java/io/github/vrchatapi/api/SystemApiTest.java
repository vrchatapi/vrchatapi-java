...
public class SystemApiTest {
     ...
     */
    @Test
    public void getCurrentOnlineUsersTest() throws ApiException {
        Integer response = api.getCurrentOnlineUsers();
    ...
    public void getHealthTest() throws ApiException {
        InlineResponse2002 response = api.getHealth();
     ...
     */
    @Test
    public void getSystemTimeTest() throws ApiException {
        OffsetDateTime response = api.getSystemTime();
