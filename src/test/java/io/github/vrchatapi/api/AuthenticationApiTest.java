...
public class AuthenticationApiTest {
    ...
    public void deleteUserByIdTest() throws ApiException {
        String userId = null;
        CurrentUser response = api.deleteUserById(userId);
    ...
    public void verify2FATest() throws ApiException {
        ...
        InlineResponse2001 response = api.verify2FA(inlineObject);
     ...
     */
    @Test
    public void verifyAuthTokenTest() throws ApiException {
        InlineResponse200 response = api.verifyAuthToken();
     ...
     */
    @Test
    public void verifyRecoveryCodeTest() throws ApiException {
        InlineObject1 inlineObject1 = null;
        InlineResponse2001 response = api.verifyRecoveryCode(inlineObject1);
